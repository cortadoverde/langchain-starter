...
export async function POST(req: NextRequest) {
    try {
        ...
        # INSTRUCCIONES #
        Clasifica el siguiente input basado en las preguntas y opciones anteriores. Devuelve un JSON con un puntaje para cada opción en cada pregunta, donde el puntaje indica la afinidad entre el input y las opciones.

        # OUTPUT #
        {
            scores: [ %question.id%: { a: %score%, b: %score%, c: %score%, d: %score% }, ... ]
        }
